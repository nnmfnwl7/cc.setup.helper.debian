...
>> number of orders that could DXBOT let opened at same time for ${cc_ticker_maker}/${cc_ticker_taker}
${cc_max_open_orders_help_text}"

cc_max_open_orders_help_text_opposite="
>> number of orders that could DXBOT let opened at same time for ${cc_ticker_taker}/${cc_ticker_maker}
${cc_max_open_orders_help_text}"
