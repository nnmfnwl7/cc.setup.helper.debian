...
cc_install_dir_path_default="~/Downloads/ccwallets/blocknet/blocknet.qa"
cc_chain_dir_path_default="~/.blocknet.qa"
cc_wallet_name_default="wallet_block_qa"
...
cc_git_src_branch="origin/4.3.3-features-dev"
cc_git_commit_id="fc74d2571de066b3abb32b22ea74f1418166ceec"
...
--enable-reduce-exports --enable-static --without-miniupnpc --without-zmq
--with-gui=auto
'
